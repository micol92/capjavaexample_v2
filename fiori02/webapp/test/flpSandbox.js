		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori02 App Title",
									"targetURL": "#Fiori02AppTitle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Fiori02AppTitle-display": {
								"semanticObject": "Fiori02AppTitle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiori02",
									"url": sap.ui.require.toUrl("fiori02")
								}
							}
						}
					}
